...
public class Feed_ActionForm extends org.apache.struts.action.ActionForm {
...
ActionErrors errors = new ActionErrors();
     if((getSub()==null)||getSub().length()==0)
    {
    errors.add("sub",new ActionMessage("errors.sub.required"));
