...
<table WIDTH=100% BORDER="0" CELLPADDING=0 CELLSPACING=0 height="200" bordercolor="black">
    <form  action="gal_audioSample.do?method=inMrStrm" enctype="multipart/form-data" method="post">
    <tr> 
    <td>Upload More Audio Samples</td> </tr>
...
<%}%>
    ...
    <input type="submit" name="save" value="Upload Samples "> 
    </td> 
    </tr>   
    <tr><td>
    </td></tr>
