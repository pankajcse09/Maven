       ...
       <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/pro_drop_1/laycss.css" />
        ...
        <script language="javascript" src="<%=request.getContextPath()%>/css/menu.js"></script>
         ...
         <script language="javascript">
             ...
             function validate1(){    
           if(document.forms[1].elements["name"].value==""){
           alert("Enter your first name");
           document.forms[1].elements["name"].focus();
           return false;
           }
           if(document.forms[1].elements["last_name"].value==""){
           alert("Enter your last name");
           document.forms[1].elements["last_name"].focus();
           return false;
           }
           
           if(document.forms[1].elements["emailid"].value==""){
           alert("Enter your email id");
           document.forms[1].elements["emailid"].focus();
           return false;
           }
           
           if(document.forms[1].elements["password"].value==""){
           alert("Enter your password");
           document.forms[1].elements["password"].focus();
           return false;
           }
           
           if(document.forms[1].elements["cpassword"].value==""){
           alert("Please confirm your password");
           document.forms[1].elements["cpassword"].focus();
           return false;
           }
           
           if(document.forms[1].elements["cpassword"].value!=document.forms[1].elements["password"].value){
           alert("Password is not matching. Please try again");
           document.forms[1].elements["cpassword"].focus();
           return false;
           }
           
           if(document.forms[1].elements["mobileno"].value==""){
           alert("Enter your contact no");
           document.forms[1].elements["mobileno"].focus();
           return false;
           }
           
           if(document.forms[1].elements["homeaddress"].value==""){
           alert("Enter your address");
           document.forms[1].elements["homeaddress"].focus();
           return false;
           }
           
           if(document.forms[1].elements["city"].value==""){
           alert("Enter your city");
           document.forms[1].elements["city"].focus();
           return false;
           }
           
           if(document.forms[1].elements["pincode"].value==""){
           alert("Enter your Zip/Postal code");
           document.forms[1].elements["pincode"].focus();
           return false;
           }
           return true;
           }    
...
<form name="f" method="post" action="<%=request.getContextPath()%>/customerUserlog.do?method=customer_Authenticate" onsubmit="return validate();">
                             <div class="eft">
                    <table>
...
<tr><td align="center" colspan="2" class="SubmitB"><input type="submit" name="regBtn" id="regBtn" value="LOGIN" /></td></tr>
                           <input type="hidden" name="check" value="login"> 
                            ...
                            <td valign="top" width="50%">
  <form name="f1" method="post" action="<%=request.getContextPath()%>/UserRegist_customer.do?method=registUserAction_Customer" onsubmit="return validate1();">
       <div class="ight">
    <table>
        <%if(request.getAttribute("msg1")!=null){%>
<tr><td colspan="2"><font color="black" size="2"><b><%=request.getAttribute("msg1")%></b></font></td></tr>   
<%}%>     
