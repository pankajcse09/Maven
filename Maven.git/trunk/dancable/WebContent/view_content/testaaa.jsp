...
<body>
	<div id="wrapper">
		...
		<form method="POST" action="DoDirectPaymentServlet" name="frmDCC">
			<div id="request_form">
				<div class="params">
					<div class="param_name">First Name*</div>
					<div class="param_value">
						<input type=text size=30 maxlength=32 name=firstName value=anu>
					</div>
				</div>
				<div class="params">
					<div class="param_name">Last Name*</div>
					<div class="param_value">
						<input type=text size=30 maxlength=32 name=lastName value=singh>
					</div>
				</div>
				...
				<div class="params">
					...
					<div class="param_value">
						<input type=text size=19 maxlength=19 name="creditCardNumber" value="4535284537451045">
					</div>
				</div>
				<div class="params">
				...
				<div class="submit">
					<input type="submit" name="DirectPaymentBtn" value="DoDirectPaymentServlet" /><br />
				</div>
