...
<table width="100%" border="0" cellpadding="0" cellspacing="5" align="center">
    ...
    <tr><td  bgcolor="">  
    <table width="100%" align="center"><tr><td width="100%" align="center" colspan="2"><font color="darkblue" size="3"><b>List Of Guest Users</b></font></td></tr></table>
...
<td><FONT STYLE="font-weight:normal;color:black;font-size:15px"><%=rb.getEmail_id()%></font></td>
    ...
    <td width="20%"><font style="font-size:12"><a href="selectall_order_userid.do?userid=<%=rb.getEmail_id()%>&odid=<%=rb.getOrder_id()%>">view</a></font></td>
    </tr>
    <%}%> 
