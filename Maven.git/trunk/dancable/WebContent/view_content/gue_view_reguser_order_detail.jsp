...
jb=(JavaBean1)request.getAttribute("jbean");    
     ...
     <div id="conta" align="center">
       ...
       <table border="0" width="100%"  ALIGN="CENTER" bgcolor="#ffffff" valign="top">
<tr>
...
<tr><td><table align="center">
 ...
 <table width="80%" border="0" align="center">
     <tr><td align="center"><font style="font-weight: bold;color:#726C7B;font-size:18px;text-decoration:underline;">View Guest Order Details</font>
</td>
</tr>
 <% if(address.size()!=0){
