...
<tr><td valign="top"><font color="darkblue" size="3" style="text-decoration: underline"><b>List Of Registered User's Order Between Date</b></font></td></tr>
  </table>                               
  <table align="center">
...
<td><a href="<%=request.getContextPath()%>/get_item_date.do?userid=<%=jb.getLoginid()%>&odid=<%=jb.getOrder_id()%>
&fd=<%=fdate%>&td=<%=tdate%>&method=get_item_daterange" target="_blank">view order</a></td>
</tr>
<%}%>    
</table> 
<% }else if(sz==0){%>
