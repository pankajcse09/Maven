...
<title>JavaScript Dropdown Menu Demo</title>
 <LINK href="<%=request.getContextPath()%>/view_content/style.css" type="text/css" rel="STYLESHEET">
<SCRIPT src="<%=request.getContextPath()%>/view_content/script.js" type="text/javascript"></SCRIPT>
...
<ul class="menu" id="menu">
 ...
 sub_id=newcateg.getSubcat_id();
         ...
         %>
                                             <li class="topline"><A href="subcatdet.do?id=<%=sub_id%>&method=view_ItemDetail"><%=sub_catname%></A></li>
