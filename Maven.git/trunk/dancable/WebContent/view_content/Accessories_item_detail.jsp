...
<tr><td width="20%"  valign="top"><%@include file="/view_content/Accessories_item.jsp"%></td>
 ...
 <tr><td valign="top"  BACKGROUND="./fashion_img/bg.jpg">
  ...
  String status="";
   ...
   int itemid=0;
    ...
    <%if(!pre.equals("")){%>
    <a href="subcatdet_acc.do?method=Accessories_ItemDetail&pr=<%=pre%>"><font size='1' color='black'>Previous</font></a>
    <%}
    if(!nxt.equals("")){%>
   <a href="subcatdet_acc.do?method=Accessories_ItemDetail&pr=<%=nxt%>"><font size='1' color='black'>Next</font></a>
   <%}%>
   </td></tr>
