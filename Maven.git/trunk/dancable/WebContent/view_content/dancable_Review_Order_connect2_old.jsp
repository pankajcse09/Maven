...
<table width="100%" cellspacing="0" cellpadding="0">
		  ...
		  <!--<form method="post" action="https://connect.firstdataglobalgateway.com/IPGConnect/gateway/processing" name="mainform">-->
                <form method="post" action="<%=request.getContextPath()%>/result.do" name="mainform">
                <!--<form action="https://connect.merchanttest.firstdataglobalgateway.com/IPGConnect/gateway/processing" method="post" name="mainform">-->
