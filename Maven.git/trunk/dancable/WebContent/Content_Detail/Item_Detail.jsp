...
<link href="./scrollbar/libs/prettify/prettify.css" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="./scrollbar/libs/prettify/prettify.js"></script>
<script type="text/javascript" src="./scrollbar/jquery.slimscroll.js"></script>
<link href="./scrollbar/style.css" type="text/css" rel="stylesheet" />
<script type="text/javascript">
function myFunction() {

    var dropdown1 = document.getElementById('myList');
   var a = dropdown1.options[dropdown1.selectedIndex].value;
   var b = dropdown1.options[dropdown1.selectedIndex].text;
   var textbox = document.getElementById('demo');
   var textbox1 = document.getElementById('cat');
     textbox.value = a;  
     textbox1.value = b;  
}
</script>
...
return myFormattedNum; 
 ...
 <script language="javascript">
          ...
          function addToCart()
          {   var categ = document.getElementById("myList").value
              if(categ =="")
               {    
...
url=url+"?method=add_to_mywishlist&itemid="+itemid;
//alert(url);
...
window.open(url,'danceables music','width=433,height=450,menubar=no,scrollbars=yes,resizable=1');
...
<table width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <form name="ab" method="post" action="create_cart.do?method=create_cart">
                    <table valign="top" width="80%" cellpadding="0" cellspacing="0" border="0" align="right">
...
//  fn1=request.getContextPath()+"/Imge/"+itembe.getFilename();
   ...
   String catid = (String)session.getAttribute("scid");
        ...
        // out.println(catid); 
       //  String catid1=(String)session.getAttribute("scid1");
   // out.println(catid1);
%>
...
<input type="hidden" name="brand" value="<%=itembe.getBrand()%>"><%}%>
    ...
    <td width="50%" valign="bottom" style="padding-left: 10px" align="left">
     <table border="0"><tr><td valign="top"><font style="color:black;font-family: Arial; font-size:14px; font-weight: 600;">Product</font></td>
             <td><font style="color:black;font-family: Arial;font-size:14px; font-weight: 600;"><%=itembe.getBrand()%></font></td></tr>
             <tr valign="top"><td><font style="color:black;font-family: Arial;font-size:14px; font-weight: 600;">Code:</font></td>
                 <td><font style="color:black;font-size:14px;font-family: Arial; font-weight: 600;"><%=itembe.getProd_id()%></font></td></tr>
                 <tr valign="top"><td><font style="color:black;font-family: Arial;font-size:14px; font-weight: 600;">Purchase Type:</font></td>
                 <td><font style="color:black;font-size:14px;font-family: Arial; font-weight: 600;"> 
                
                      <select id="myList" name="cat_price" onchange="myFunction()">
                          <%if(catid.equals("1") || catid.equals("2")){%>
                          <option value="" >Select Category</option>
                             <option value="<%=itembe.getPrice()%>">shipping request</option>
                           <option value="<%=itembe.getDownprice()%>">download request</option>
             
                         <%}else if(catid.equals("4") || catid.equals("3")){%>
                          <option value="<%=itembe.getPrice()%>">shipping request</option>
                           <%}%>
                      </select>
                           </font></td></tr>
                 <tr><td valign="top"><font style="color:black;font-size:14px;font-family: Arial; font-weight: 600;">Price:</font></td>
                 <td><font style="color:black;font-size:14px;font-family: Arial; font-weight: 600;"><input type="text" name="total"  id="demo" size="5" value="" readonly></font></td> 
                 
                 </tr>
                    <tr><td valign="top"><font style="color:black;font-family: Arial;font-size:14px; font-weight: 600;">Quantity in Basket:&nbsp</font></td>
...
<input type="hidden" name="prod_id" value="<%=itembe.getProd_id()%>">
        ...
        <td><div id="wish">
                <% if(check==0){%>
                    <input style="cursor: pointer" type="button" size="12" value="Add to My WishList" onclick="add_to_wishlist('<%=itembe.getItem_id()%>')"></input>
                    <%}else{%>
     ...
     for(int i=0;i<relatedItems.size();i++)
      {
        ...
        <div class="rel_items">
            ...
            <div class="rel_itemDetail">
                ...
                <div><b>Price: <%=rf.round_toTwo(item.getPrice())%></b></div>
                <div><a href="detail_item.do?id=<%=item.getItem_id()%>">
                        <img  src="<%=request.getContextPath()%>/images/more.png" border="0" width="90"></a></div>
            </div>
