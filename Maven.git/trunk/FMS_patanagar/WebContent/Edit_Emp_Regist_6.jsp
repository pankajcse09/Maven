...
<form name="f2" method="post" action="<%=request.getContextPath()%>/Emp6.do?method=eDetail6">
...
<%}%> 
<form method="post" onSubmit="return validate(this.form)" action="<%=request.getContextPath()%>/Emp6.do?method=updateEmpAction6">
 <hr color="maroon">
 <table align="center" width="100%" border="0"><tr><td align="left" valign="middle"><font size="2" color="maroon"><b>References Name & Address of three persons by whom you are well known</b></font></td></tr></table>
 <hr color="maroon">
...
<table align="center" width="100%" border="0" bgcolor="">    
<tr><td align="left" valign="middle" colspan="4"><b>Give Three References with Telephone Nos.</b></td></tr> 
<tr><td align="center" valign="middle" width="10%" class="tdcolor1">1.</td><td align="left" valign="middle" width="90%"><textarea name="refer1" cols="75" rows="2"><%=jb.getRefer1()%></textarea></td></tr> 
<tr><td align="center" valign="middle" width="10%" class="tdcolor1">2.</td><td align="left" valign="middle" width="90%"><textarea name="refer2" cols="75" rows="2"><%=jb.getRefer2()%></textarea></td></tr>
<tr><td align="center" valign="middle" width="10%" class="tdcolor1">3.</td><td align="left" valign="middle" width="90%"><textarea name="refer3" cols="75" rows="2"><%=jb.getRefer3()%></textarea></td></tr>
</table>
