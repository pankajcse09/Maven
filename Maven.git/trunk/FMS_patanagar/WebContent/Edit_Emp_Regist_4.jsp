...
ar1=(ArrayList)jb.getLanguages();
hm1=(HashMap)jb.getRead();
hm2=(HashMap)jb.getWrite();
hm3=(HashMap)jb.getSpeak();
%>
<html>
  <head>
...
<form name="f2" method="post" action="<%=request.getContextPath()%>/Emp4.do?method=eDetail4">
...
<%}%>   
<form method="post" onSubmit="return validate(this.form)" action="<%=request.getContextPath()%>/Emp4.do?method=updateEmpAction4">
 <hr color="maroon">
...
<tr><td align="left"><%=ar1.get(j)%><input type="hidden" name="languages" value="<%=ar1.get(j)%>"></td><td align="center"><input type="text" name="read" value="<%=hm1.get(ar1.get(j))%>"></td><td align="center"><input type="text" name="write" value="<%=hm2.get(ar1.get(j))%>"></td><td align="center"><input type="text" name="speak" value="<%=hm3.get(ar1.get(j))%>"></td></tr> 
<%}%>
</table>
