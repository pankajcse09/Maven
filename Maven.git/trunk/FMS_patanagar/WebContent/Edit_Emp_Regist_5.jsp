...
ar1=(ArrayList)jb.getActivity();
hm1=(HashMap)jb.getRepresentLevel();
hm2=(HashMap)jb.getActivityYear();
hm3=(HashMap)jb.getPositionStood();
%>
<html>
  <head>
...
<form name="f2" method="post" action="<%=request.getContextPath()%>/Emp5.do?method=eDetail5">
...
<%}%> 
<form method="post" onSubmit="return validate(this.form)" action="<%=request.getContextPath()%>/Emp5.do?method=updateEmpAction5">
<hr color="maroon">
 <table align="center" width="100%" border="0"><tr><td align="left" valign="middle"><font size="2" color="maroon"><b>Co-curricular and Extra curricular activities</b></font></td></tr></table>
 <hr color="maroon">
...
<td align="center" valign="middle" class="tdcolor1">Year</td>
<td align="center" valign="middle" class="tdcolor1">Position took/Stood</td></tr> 
<%for(int j=0;j<ar1.size();j++){%>
<tr><td align="left"><%=ar1.get(j)%><input type="hidden" name="activity" value="<%=ar1.get(j)%>"></td><td align="center"><textarea name="rlevel" cols="25" rows="3"><%=hm1.get(ar1.get(j))%></textarea></td><td align="center"><textarea name="actyear" cols="25" rows="3"><%=hm2.get(ar1.get(j))%></textarea></td><td align="center"><textarea name="pstood" cols="25" rows="3"><%=hm3.get(ar1.get(j))%></textarea></td></tr> 
<%}%>
</table>
