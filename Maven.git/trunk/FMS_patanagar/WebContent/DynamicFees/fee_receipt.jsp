...
ArrayList al=(ArrayList)seo.getFeeList();
...
<script language="javascript">
 ...
 document.f1.action="<%=request.getContextPath()%>/check.do?method=getdetails";
 document.f1.submit();
 }
 function genIdCard(){
...
<form name="f1" method="post" action="<%=request.getContextPath()%>/check.do?method=getdetails">
...
<tr><td style="border-collapse:collapse;border:1px solid black"><table>
   <tr><td align="left"><font style="font-size:12"><b>Fee Receipt No.&nbsp;&nbsp;&nbsp;&nbsp;<%=seo.getFeeReceipt()%></b></font></td>
    <td align="right" style="padding-left:170px"><font style="font-size:12"><b>Submission Date.&nbsp;&nbsp;&nbsp;&nbsp;<%=seo.getDateofadd()%></b></font></td></tr>
  </table></td></tr>
...
<font style="font-size:12"><b>Gender:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;<%=seo.getGender().toUpperCase()%></b></font></td></tr> 
<tr><td style="border-collapse:collapse;border:1px solid black">
...
<tr><td style="border-collapse:collapse;border:1px solid black">
<font style="font-size:12"><b>Class:&nbsp;&nbsp;&nbsp;<%=seo.getDegree().toUpperCase()%>,&nbsp;<%=seo.getBranch().toUpperCase()%>,&nbsp;<%=seo.getSemester().toUpperCase()%></b></font></td></tr>
</table>    
<table width="100%" align="center" border="1" style="border-collapse:collapse;border:1px solid black">
<%for(int i=0;i<ar.size();i++){%>    
<tr><td width="50%" style="border-collapse:collapse;border:1px solid black"><font style="font-size:12"><b><%=ar.get(i).toString().toUpperCase()%></b></font></td>
    <% if(ar.get(i).toString().equalsIgnoreCase("REGISTRATION FEE")){regis_fee=Double.parseDouble(hm.get(ar.get(i)).toString());}%>
<td width="50%" style="border-collapse:collapse;border:1px solid black"><font face="Rupee Foradian" size="3">`</font>&nbsp;<%if(hm.get(ar.get(i))!=null){%><%=hm.get(ar.get(i))%><%}%></td></tr>
<%}%>
<%if(ar.size()!=0){
    fine=seo.getTot_days()*seo.getPfine();
       %>
<tr><td width="50%" style="border-collapse:collapse;border:1px solid black"><font style="font-size:12"><b>LATE FEE SUBMISSION FINE (Days: <%=seo.getTot_days()%>)</b></font></td>
    <td width="50%" style="border-collapse:collapse;border:1px solid black">
        <%if(seo.getTot_days()<=30){%>
        <font face="Rupee Foradian" size="3">`</font>&nbsp;<%=seo.getFine()%>
    <%}else{%>
    <font face="Rupee Foradian" size="3">`</font>&nbsp;<%=seo.getMax_fine()%>
    <%}%>
    </td>
</tr>
<tr><td width="50%" style="border-collapse:collapse;border:1px solid black"><font style="font-size:12"><b>TOTAL FEE SUBMITTED</b></font></td>
<td width="50%" style="border-collapse:collapse;border:1px solid black"><font face="Rupee Foradian" size="3">`</font><!--<img height="10" width="10" src="./image/rupee1.JPG"></img>-->
<b><%=seo.getFeeTotal()+regis_fee%><input type="hidden" name="feetotal" value="<%=seo.getFeeTotal()-regis_fee%>"></b></td></tr>
<tr><td width="50%" style="border-collapse:collapse;border:1px solid black"><font style="font-size:12"><b>REMAINING FEE</b></font></td>
<td width="50%" style="border-collapse:collapse;border:1px solid black"><font face="Rupee Foradian" size="3">`</font><!--<img height="10" width="10" src="./image/rupee1.JPG"></img>-->
<b><%=(seo.getTotalFee()+seo.getFine())-(seo.getFeeTotal()+regis_fee)%></b></td>
</tr>
<%}%>
</table>  
</td>
