 ...
 <tr><td valign="top" style="padding-left: 5px" width="160">            
        ...
        <td width="2" bgcolor="#000000"></td>
             <td valign="top" align="left">  
                 <table width="80%" ><tr><td><a href="javascript:Clickheretoprint('printit')"><font color="yellow" size="2"><u><b>PRINT</b></u></font></a></td>
                         <td align="center"><font color="darkred"><%=request.getAttribute("msg")%></font> </td>
                     </tr></table>
                 <div id="printit">
                     <% for(int k=0;k<2;k++){%>
...
<%}}%>
                  ...
                  <table><tr><td colspan="2"><a href="javascript:Clickheretoprint('printit')"><font color="yellow" size="2"><u><b>PRINT</b></u></font></a></td></tr></table>
</td></tr></table>
           </td></tr>       
