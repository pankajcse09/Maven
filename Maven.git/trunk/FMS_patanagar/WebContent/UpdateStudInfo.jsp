   ...
   <% 
      ...
      out.println("<h5>" + e.getMessage() + "</h5>");
          ...
          try{ 
           ...
           String qr1="select distinct sessions from studinfo where TO_NUMBER(substr(sessions,1,4))=(select max(TO_NUMBER(substr(sessions,1,4))) from studinfo)";
...
<tr><td width="100%"><%@include file="/HomeLink.jsp"%></td></tr> 
 <tr><td valign="top"><table width="100%" height="20"><tr><td></td></tr>
 <tr><td valign="top" align="left"><font color="green"><b>Last Updated Date:<%=ud%></b></font></td><td valign="top" align="right"><font color="green"><b><%=dts%></b></font></td></tr>
    ...
    <form name="f1" method="post" action="<%=request.getContextPath()%>/StudInfoUpdate">
        <center><font color="#000080" size="3"><b>Academic Information</b></font></center><br>
