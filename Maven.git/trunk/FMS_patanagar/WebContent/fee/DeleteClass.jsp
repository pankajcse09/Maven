...
<%
  ...
  try{
  ar1=(ArrayList)mm.retriveClassesId(); 
  }
...
<table style="padding-left: 400px">
        <tr><td align="center"><h2><font color="darkblue" size="4"><u>Delete Semester</u></font></h2></td></tr>
   </table></td></tr>
                <tr><td style="padding-left: 200px">
    <form method="post">
     <table  align="center" border="0" style="border-collapse:collapse" width="500" bgcolor="#FFFFCC"> 
     <%if(request.getAttribute("msg")!=null){%>
     <tr><td colspan="2"><font color="red"><b><%=request.getAttribute("msg")%></b></font></td></tr>   
     <%}%>     
     <tr><td class="tdcolor1" colspan="2"><font style="font-size:12;font-weight:bold">Class</font></td></tr>     
     <%for(int i=0;i<ar1.size();i++){
     jb=(JavaBean)ar1.get(i);  
     %>
     <tr><td><%=jb.getClas()%></td><td><a href="<%=request.getContextPath()%>/DeleteClasses.do?para=<%=jb.getId()%>&method=deleteClassAction"><font color="blue">Delete</font></a></td></tr>     
     <%}%>
     </td></tr></table>
    </form>
    </td></tr>
