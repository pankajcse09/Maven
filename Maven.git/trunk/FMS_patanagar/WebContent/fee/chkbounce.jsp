...
<tr><td valign="top">
  ...
  <table align="center"><tr><td><center><font color="#34282C" size="4"><u>Cancel Bounced Check</u></font></center></td></tr></table> 
<form  method="post" action="dispchk.do?dis=disp" name="mulchk" onsubmit="return validate()">
<table width="100%">
<%  if((String)request.getAttribute("sub")!=null)
    out.println("<font color='red'><b>"+(String)request.getAttribute("sub")+"</b></font>"); %>  
<tr><td><font color="red" size="2">Please enter the Draft Number</font></td></tr>
<tr>
 
<td>Check Number:<input type="text" size="20" name="checknumber" value="">
<table>
...
<input type="submit" value="Display">
   ...
   <form action="updatefee.do" method="post" name="chkb" onsubmit="return chkvalidate()">

    <% 
    String chknum= (String)request.getParameter("checknumber");  %>
...
<td align="center"><font size="2"><b>FromDate</b></td>
<td align="center"><font size="2"><b>ToDate</b></td>
...
<td align="center"><font size="2"><b><b>Remained Fee</b></font></td>
</tr>
...
<td><%=seo.getFromdate()%></td><input type="hidden" name="fromdate" size="10" value="<%=seo.getFromdate()%>" >
<td><%=seo.getFromdate()%></td><input type="hidden" name="todate" size="10" value="<%=seo.getTodate()%>" >
...
<td><%=seo.getChkamount()%></td><input type="hidden" name="deduct" size="5"  value="<%=seo.getChkamount()%>">
<td><%=seo.getRemain()%></td><input type="hidden" name="remain" size="5" value="<%=seo.getRemain()%>" >
</tr>

<input type="hidden" name="damount" value="<%=seo.getChkamount()%>">
   ...
   e.printStackTrace();}%>
    <table> 
<tr><td>Penalty:</td><td><input type="text" name="penalty" value=""></td>
<tr><td></td><td><input type="submit" value="Cancel Check/Draft"></td></tr>
</table>   
