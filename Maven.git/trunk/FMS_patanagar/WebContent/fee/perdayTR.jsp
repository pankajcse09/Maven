...
<tr><td valign="top">
<table align="center"><tr><td><center><font color="#34282C" size="4"><u>Per Day Transport Fee Report</u></font></center></td></tr></table>

 <form name="studre"  method="post" action="<%=request.getContextPath()%>/pdtfreport.do" onsubmit="return chkvalidate()">
<table>
...
am1=rp.tfeeResult(fsubdate,srnum);
fn1=rp.returnTFine(fsubdate,srnum); 
...
%>
             <tr>
               <td align="center"><font color=black><b><%=++k%></b></font></a></td>
