...
<form  method="post" action="<%=request.getContextPath()%>/fnex.do?disp=disp">
...
<form name="formfine" action="<%=request.getContextPath()%>/fnex.do?enter=enter" method="post" onsubmit="return chkvalidate()">
...
<tr><td><font size="2"><b>Class</b></font></td><td><%=seo.getClasses()%></td></tr>
<tr><td><font size="2"><b>Section</b></font></td><td><%=seo.getSection()%></td></tr>
