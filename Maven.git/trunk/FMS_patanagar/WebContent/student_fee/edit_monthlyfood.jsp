<%-- 
    Document   : edit_monthlyfood
    Created on : Nov 4, 2014, 6:34:42 PM
    Author     : kapil
--%>
<%
String loginfor="";
...
<title>Edit Student Monthly Food Details</title>
...
<form name="f1" method="post" action="<%=request.getContextPath()%>/retSubm_fam.do?method=retSubmited_food_b" onsubmit="return validate()">
    <table width="100%" align="center" valign="top"><tr><td colspan="2" align="center" valign="top">
                <font color="darkred" size="3">Edit Monthly Food Bill Details</font></td></tr>
...
<%}%>
    ...
    <tr><td valign="top"><font style="font-size:12;color:white"><b>Student Id</b></font></td>
        <td><input type="text" name="stud_id" value=""></td></tr>
    <tr><td></td><td><input type="submit" value="Check"></td></tr>    
</table>  
</form>
    <hr color="maroon">
    <%if(!seo.getStud_id().equals("")){%>
<form name="f2" method="post" action="<%=request.getContextPath()%>/updateSubm_fam.do?method=updateSubmited_food_b" onsubmit="return validate1()">        
<table width="35%" align="center">
    <tr><td valign="top"><font style="font-size:12;color:white"><b>Session</b></font></td>
        <td><%=seo.getSession()%><input type="hidden" name="stud_id" value="<%=seo.getStud_id()%>">
        <input type="hidden" name="session" value="<%=seo.getSession()%>">
        </td></tr>
    <tr><td valign="top"><font style="font-size:12;color:white"><b>Student Id</b></font></td>
        <td><%=seo.getStud_id()%></td></tr>
    <tr><td valign="top"><font style="font-size:12;color:white"><b>Month</b></font></td>
        <td>
            <select name="month">
                <option value="<%=seo.getMonth()%>"><%=seo.getMonth()%></option>
    ...
    <tr><td valign="top"><font style="font-size:12;color:white"><b>Amount</b></font></td>
        <td><input type="text" name="famount" value="<%=seo.getMonthlyFood()%>"></td></tr>
    <tr><td align="left" style="padding-right: 20px"><font style="font-size:12" color="white"><b>Date Of Bill</b></font></td>
        <td><input type="text" name="date1" value="<%=sde.format(seo.getDate())%>"><font style="color: darkred">(dd/mm/yyyy)</font></td></tr>
