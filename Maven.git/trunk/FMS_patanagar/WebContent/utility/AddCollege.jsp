<%-- 
    Document   : AddCollege
    Created on : Feb 25, 2015, 9:26:00 PM
    Author     : kapil
--%>
...
function validate(){
    if(document.f1.elements["college_name"].value==""){
alert("Please Enter College Name");
document.f1.elements["college_name"].focus();
return false;
 }

if(document.f1.elements["college_code"].value==""){
alert("Please Enter College Code");
document.f1.elements["college_code"].focus();
return false;
 }
return true;
}
...
<table style="padding-left: 350px">
    <tr><td colspan="2" align="center"><font style="font-size:16;font-weight:bold;color:darkblue">Add College</font></td></tr>
</table></td></tr>
<tr><td style="padding-left: 200px">
<form name="f1" method="post" action="<%=request.getContextPath()%>/addCollege.do?method=addCollege" onsubmit="return validate();">
...
<%}%>
<tr><td><font style="font-size:12;color:black"><b>College Name</b></font></td>
       <td><input type="text" name="college_name"></td></tr>
<tr><td><font style="font-size:12;color:black"><b>College Code</b></font></td>
       <td><input type="text" name="college_code"></td></tr>
