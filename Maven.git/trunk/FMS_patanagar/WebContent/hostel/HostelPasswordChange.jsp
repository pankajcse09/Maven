<%-- 
    Document   : HostelChangePassword
    Created on : Mar 1, 2015, 7:27:24 PM
    Author     : kapil
--%>
...
%>
                 ...
                 <tr><td colspan="2"><font color="red"><%if(request.getAttribute("msg")!=null){%><%=request.getAttribute("msg")%><%}%></font></td></tr> 
                 <tr>
