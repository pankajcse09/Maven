...
<tr><td valign="top">    
    ...
    <form name="f1" method="post" action="<%=request.getContextPath()%>/SelectInfoAct1.do?method=selectInfoAction1" onsubmit="return validate();">      
        <center><font color="#000080" size="3"><b>Update Marks</b></font></center><br>
        <table align="center" border="1" class="t">  
      <tr><td colspan="2">Session:</td><td colspan="2"><select name="sessions"> 
