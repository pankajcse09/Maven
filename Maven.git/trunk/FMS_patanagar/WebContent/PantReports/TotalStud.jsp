<%-- 
    Document   : TotalStud
    Created on : Dec 17, 2013, 1:14:47 PM
    Author     : kapil
--%>
...
<%}
    ...
    <td>
<font color="white"><b>Batch:<select name="batch">     
<%if(!sr.equals("")){%>   
...
<%for(int i=0;i<=7;i++)
{
    if(!sr.equals(String.valueOf( Syear-i))){
        %>
...
<td>
    <!--<font color="white"><b>Year:<select name="year">  
            ...
            <input type="submit" name="ret" value="Display">
            </td>
</tr>
</table>
</form>
...
<%}%>   
<tr><td><font style="font-size:14px" color="black"><b>All Student List of <span style="color:darkblue;"><%=dg%>, <%=sr%></span>
            </b></font>
    </td></tr>
</table>
