...
<title>Draft Amount Report</title>

<script language="javascript">

function validate()
{
    if(document.f1.kinds[0].checked==false&&document.f1.kinds[1].checked==false){    
    alert("Please checked on either draft processing date or draft receiving date.");
...
<table>
    <tr><td style="padding-left: 390px"><font color="darkblue" size="3"><u><b>BankWise Draft Amount List</b></u></font></td></tr> 
</table>
 
<form name="f1" method="post" action="<%=request.getContextPath()%>/retBankwise_amount.do?method=retBankwise_amnt" onsubmit="return validate()">
...
<%}%>
                ...
                <td align="left" style="padding-right: 20px"><font style="font-size:12" color="white"><b>Date1</b></font><br><script>DateInput('dated1',true,'dd/mm/yyyy')</script></td>
                <td align="left" style="padding-right: 20px"><font style="font-size:12" color="white"><b>Date2</b></font><br><script>DateInput('dated2',true,'dd/mm/yyyy')</script></td>
...
<div id="printit">
    ...
    <tr><td style="padding-left: 0px" align="center"><h2><font color="darkblue" size="3"><u><b>BankWise Fee Amount List</b></u></font></h2></td></tr> 
</table>
...
<table width="90%" align="left" style="">
       <tr><td colspan="10"><font style="font-size:16;font-weight:bold">Total Received:</font>&nbsp;&nbsp;
...
<%}%>
<tr><td colspan="10" align="right"><font style="font-size:14px;font-weight:bold">TOTAL</font></td><td align="right"><b><%=df.format(tt)%></b></td></tr>
</table>
<table width="90%" align="center">
    ...
    <tr>
           ...
           <td width="50%" align="left">
                 ...
                 <a href="./retBankwise_amount.do?method=retBankwise_amnt&page=<%=curpage+1%>&session=<%=ssn%>&dated1=<%=dt1%>&dated2=<%=dt2%>&bnk_name=<%=bnk%>&kinds=<%=kinds%>">
                     <strong>Older</strong>
                          </a>
                 <%}%>
        </td>
