...
<title>Update Fee Draft</title>

<script language="javascript">
function updateAmntDraft(bnk)
{
  document.f2.method="get";
 document.f2.action="<%=request.getContextPath()%>/updateAmntDr.do?method=updAmntDr&bnk_name="+bnk;
 document.f2.submit();
}
...
<table>
    <tr><td style="padding-left: 390px"><h2><font color="darkblue" size="3"><u><b>Programme Draft List</b></u></font></h2></td></tr> 
</table>
 
<form name="f1" method="post" action="<%=request.getContextPath()%>/retAmntDraftToBn.do?method=checkAmntDraft" onsubmit="return validate()">
...
<%}%>
<form name="f2" action="<%=request.getContextPath()%>/updateAmntDr.do?method=updAmntDr" method="post">
<div id="printit">
    <table width="70%" align="center">
    <tr><td style="padding-left: 0px" align="center"><h2><font color="darkblue" size="3"><u><b>Update Programme Draft</b></u></font></h2></td></tr> 
</table>
