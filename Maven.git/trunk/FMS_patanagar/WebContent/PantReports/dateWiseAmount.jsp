...
<form name="f1" method="post" action="<%=request.getContextPath()%>/RetDateWiseAmount.do?method=retDateWiseAmount">
...
<div id="printit">
    ...
    <tr><td style="padding-left: 0px" align="left"><h2><font color="darkblue" size="3"><u><b>DataWise Amount List</b></u></font></h2></td></tr> 
</table>
...
<table width="90%" align="center" border="1" bordercolor="black" style="border-collapse:collapse">
    <tr><td colspan="10"><font style="font-size:12;font-weight:bold">Date:&nbsp;&nbsp;<%=dt1%>&nbsp;&nbsp;To&nbsp;&nbsp;<%=dt2%></font></td></tr>
