...
ar1=(ArrayList)jb.getRowid();
hm1=(HashMap)jb.getEmployer();
hm2=(HashMap)jb.getEmployerDesg();
hm3=(HashMap)jb.getEmployerFrom();
hm4=(HashMap)jb.getEmployerTo();
%>
<html>
  <head>
...
<form name="f2" method="post" action="<%=request.getContextPath()%>/Emp3.do?method=eDetail3">
...
<%}%>   
<form method="post" onSubmit="return validate(this.form)" action="<%=request.getContextPath()%>/Emp3.do?method=updateEmpAction3">
 <hr color="maroon">
 <table align="center" width="100%" border="0">
<tr><td align="left" valign="middle"><font size="2" color="maroon"><b>Employment(Please give details of employment in chronological order)</b></font></td></tr></table>
 <hr color="maroon">
...
<tr><td align="center" valign="middle" class="tdcolor1">From</td><td align="center" valign="middle" class="tdcolor1">To</td></tr> 
<%for(int j=0;j<ar1.size();j++){%>
<tr><td align="center"><input type="hidden" name="rowid" value="<%=ar1.get(j)%>"><input type="text" name="employer" value="<%=hm1.get(ar1.get(j))%>"></td><td align="center"><input type="text" name="empdesg" value="<%=hm2.get(ar1.get(j))%>"></td><td align="center"><input type="text" name="from" value="<%=hm3.get(ar1.get(j))%>"></td><td align="center"><input type="text" name="to" value="<%=hm4.get(ar1.get(j))%>"></td></tr> 
<%}%>
</table>
