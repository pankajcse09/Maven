 ...
 * Project_Team.java
 *
 * Created on February 6, 2008, 12:39 PM
 */
...
public class Searching_Pro extends HttpServlet {
        ...
        ArrayList a2=new ArrayList();
         ...
         String search_team_name="select susername,sfname,slname,smname  from ex_studnt_reg where sdntdep='"+tdep+"'and scolge='"+tcollege+"' and susername like '"+tname+"%'";     
                                  ...
                                  out.println("DatabaseDown");
                                           ...
                                           // out.println("hello");
                                           session.setAttribute("team_mem_userid",a1);
                                             session.setAttribute("team_mem_name",a2);
                                                  session.setAttribute("team_mem_midname",a3);
                                                  session.setAttribute("team_mem_lastname",a4);
                                  ...
                                  out.println("DatabaseDown");
                                           ...
                                           // out.println("hello");
                                             ...
                                             session.setAttribute("team_mem_name",a2);
                                                  session.setAttribute("team_mem_midname",a3);
                                                  session.setAttribute("team_mem_lastname",a4);
                                                  session.setAttribute("memtype","e");
                                      RequestDispatcher  rd  = request.getRequestDispatcher("/College_Files/College_File.jsp"); 
                                         rd.forward(request,response); 
