...
public class TransFineExempt extends Action {
 ...
 /******************************Displaying Detail of fees *************************/
       ...
       String qry="Select srnum,sname,classes,section,due,rowid,buscode,route,tripnum from transfinerecord where srnum='"+srnum+"' order by rowid desc";        
       out.println(qry);  
 ...
 /***********************************Insert Data*****************************************/          
  ...
  String sql1="update transfinerecord set status='Exempted',exemptby='"+uid+"',due='"+remaindue+"' where rowid='"+rid+"'";
  out.println(sql1);    
  stmt1=cn.createStatement();
         stmt1.executeUpdate(sql1);
 
         stmt1=null;
 String sql="update transfeerecord set pamount='"+remaindue+"' where srnum='"+srnum1+"' order by rowid desc";
  out.println(sql);    
  stmt1=cn.createStatement();
  stmt1.executeUpdate(sql);
    ...
    String sub=new String(" "+srnum1+" due is Exempted");
                       ...
                       RequestDispatcher  rd1  =request.getRequestDispatcher("/fee/transfineExempt.jsp"); 
